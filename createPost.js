...
window.addEventListener("load", function(){
    ...
    addPost.getElementsByClassName("centering_icon_text")[0].style.color="black";
    //------------------------------------------------------------------------
    ...
    $('.editor').each(function(i, el) {
        var el = $(this), id = 'quilleditor-' + i, val = el.val(), editor_width = 79;
        var div = $('<div/>').attr('id', id).css({'width': editor_width + 'vw', 'height': 30 + 'vw'}).html(val);
        el.addClass('d-none');
        ...
        document.querySelector(".ql-snow .ql-picker:not(.ql-color-picker):not(.ql-icon-picker) svg").style.right = "20";
        //------------------------------------------------------------------------------------------------------------
