// THIS ENTIRE PAGE HAS BEEN DEPRICATED
//PLEASE STAY AWAY OR YOU WILL SNEEZE TWICE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//###########################################################################
var totalPosts;
var firstPost;
var uniqueContentID;
                ...
                db.collection('posts')
                    ...
                    .then((snap) => {
                        snap.docChanges().forEach((docs) => {
                            ...
                            uniqueContentID = (
                                docs.doc.data().userUID + docs.doc.data().time
                            )
                                .toString()
                                .split('.')
                                .join('');
                            ...
                            document.getElementById('tagsHere').textContent =
                                docs.doc.data().tags;
                            postDate.textContent = new Intl.DateTimeFormat(
                                'en-US',
                                dateOptions
                            ).format(docs.doc.data().time.toDate());
                            postTime.textContent = new Intl.DateTimeFormat(
                                'en-US',
                                timeOptions
                            ).format(docs.doc.data().time.toDate());
